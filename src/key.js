...
//   const latLng = S2LatLng.fromDegrees(latitude, longitude);
//   return S2Cell.fromLatLng(latLng).id.id;
// };

// const generateHashKey = (hash, keyLength = 7) => {
//   let num = hash;
//   if (typeof hash === 'string') {
//     num = Long.fromString(hash, false, 10);
//   }
//   const offset = num.lessThan(0) ? 1 : 0;
//   const denominator = Math.pow(10, num.toString(10).length - keyLength - offset);
//   return num.divide(denominator);
// };

// const generateKey = (latitude, longitude, keyLength = 7) => {
//   const hash = generateGeohash({ latitude, longitude });
//   return {
//     key: generateHashKey(hash, keyLength).toString(10),
//     hash: hash.toString(10),
//   };
// };

// const generateKeyRange = (min, max, keyLength = 7) => {
//   const minHashKey = generateHashKey(min, keyLength);
//   const maxHashKey = generateHashKey(max, keyLength);
